...
export const bikiniContestPhotosCmd = new Command("bikini-contest-photos")
  .summary("Bikini contest photos — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop bikini-contest-photos --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("bikini-contest-photos", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
