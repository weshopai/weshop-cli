...
export const freeSexyAiGeneratorCmd = new Command("free-sexy-ai-generator")
  .summary("Free sexy AI generator — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop free-sexy-ai-generator --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("free-sexy-ai-generator", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
