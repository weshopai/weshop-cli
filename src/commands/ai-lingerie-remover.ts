...
export const aiLingerieRemoverCmd = new Command("ai-lingerie-remover")
  .summary(
  ...
  .description(
    "Transform a portrait or full-body lingerie outfit photo into a bikini look image or video.\n\n" +
      ...
      "  weshop ai-lingerie-remover --image ./person.png --generated-type video --no-wait"
  )
  .requiredOption(
    "--image <path|url>",
    "Input portrait or full-body photo with a lingerie outfit — local file path or URL"
  )
