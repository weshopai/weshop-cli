...
export const seeThroughClothesFitlerCmd = new Command("see-through-clothes-fitler")
  .summary("See-through clothes filter — make clothing appear sheer and see-through")
  .description(
    ...
    "  weshop see-through-clothes-fitler --image ./person.png --batch 2"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("see-through-clothes-fitler", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
