...
export const happyWomanBikiniAiPicCmd = new Command("happy-woman-bikini-ai-pic")
  .summary("Happy woman bikini AI pic — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop happy-woman-bikini-ai-pic --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("happy-woman-bikini-ai-pic", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
