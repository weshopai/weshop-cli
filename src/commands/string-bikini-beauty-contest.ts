...
export const stringBikiniBeautyContestCmd = new Command("string-bikini-beauty-contest")
  .summary("String bikini beauty contest — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop string-bikini-beauty-contest --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("string-bikini-beauty-contest", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
