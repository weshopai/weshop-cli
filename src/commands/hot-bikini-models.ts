...
export const hotBikiniModelsCmd = new Command("hot-bikini-models")
  .summary("Hot bikini models — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop hot-bikini-models --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("hot-bikini-models", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
