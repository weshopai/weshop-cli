...
export const customBikiniCmd = new Command("custom-bikini")
  .summary("Custom bikini — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop custom-bikini --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("custom-bikini", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
