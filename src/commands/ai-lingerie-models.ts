...
export const aiLingerieModelsCmd = new Command("ai-lingerie-models")
  .summary("AI lingerie models — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop ai-lingerie-models --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("ai-lingerie-models", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
