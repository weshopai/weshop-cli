...
export const aiSexyTeensCmd = new Command("ai-sexy-teens")
  .summary("AI sexy teens — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop ai-sexy-teens --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("ai-sexy-teens", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
