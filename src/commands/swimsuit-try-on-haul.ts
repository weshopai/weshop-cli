...
export const swimsuitTryOnHaulCmd = new Command("swimsuit-try-on-haul")
  .summary("Swimsuit try-on haul — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop swimsuit-try-on-haul --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("swimsuit-try-on-haul", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
