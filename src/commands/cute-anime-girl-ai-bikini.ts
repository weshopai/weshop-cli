...
export const cuteAnimeGirlAiBikiniCmd = new Command("cute-anime-girl-ai-bikini")
  .summary("Cute anime girl AI bikini — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop cute-anime-girl-ai-bikini --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("cute-anime-girl-ai-bikini", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
