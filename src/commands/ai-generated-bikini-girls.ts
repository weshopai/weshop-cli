...
export const aiGeneratedBikiniGirlsCmd = new Command("ai-generated-bikini-girls")
  .summary("AI generated bikini girls — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop ai-generated-bikini-girls --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("ai-generated-bikini-girls", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
