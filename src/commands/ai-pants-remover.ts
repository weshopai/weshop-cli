...
export const aiPantsRemoverCmd = new Command("ai-pants-remover")
  .summary("AI pants remover — transform pants outfit photos into bikini look images or videos")
  .description(
    "Transform a portrait or full-body pants outfit photo into a bikini look image or video.\n\n" +
      ...
      "  weshop ai-pants-remover --image ./person.png --generated-type video --no-wait"
  )
  .requiredOption(
    "--image <path|url>",
    "Input portrait or full-body photo with a pants outfit — local file path or URL"
  )
