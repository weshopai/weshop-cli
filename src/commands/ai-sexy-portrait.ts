...
export const aiSexyPortraitCmd = new Command("ai-sexy-portrait")
  .summary("AI sexy portrait — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop ai-sexy-portrait --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("ai-sexy-portrait", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
