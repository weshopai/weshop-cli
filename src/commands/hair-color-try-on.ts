...
export const hairColorTryOnCmd = new Command("hair-color-try-on")
  .summary("Hair color try-on — change a person's hair color while preserving hairstyle and details")
  .description(
    ...
    "  weshop hair-color-try-on --image ./person.png --batch 4"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("hair-color-try-on", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
