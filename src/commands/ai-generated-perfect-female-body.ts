...
export const aiGeneratedPerfectFemaleBodyCmd = new Command("ai-generated-perfect-female-body")
  .summary("AI generated perfect female body — transform a person photo into a bikini model image or video")
  .description(
    ...
    "  weshop ai-generated-perfect-female-body --image ./person.png --generated-type video --no-wait"
  )
  ...
  .action(async (opts) => {
    ...
    await executeRun("ai-generated-perfect-female-body", "v1.0", { image: opts.image, wait: opts.wait }, params, extraInput);
  });
